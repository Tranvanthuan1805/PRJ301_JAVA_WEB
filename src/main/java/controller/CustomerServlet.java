...
import model.entity.dao.CustomerDAO;
...
public class CustomerServlet extends HttpServlet {
    ...
    private void listCustomers(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/views/customer-management/customer-list.jsp").forward(request, response);
    }
    ...
    private void viewCustomerDetail(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (customer != null) {
            ...
            request.setAttribute("activePage", "users");
            request.getRequestDispatcher("/views/customer-management/customer-detail.jsp").forward(request, response);
        } else {
