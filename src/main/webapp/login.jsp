    ...
    <div class="auth-container">
        ...
        <div class="auth-form">
            ...
            <c:if test="${not empty sessionScope.success}">
                <div class="success-msg"><i class="fas fa-check-circle"></i> ${sessionScope.success}</div>
            ...
            <form action="${pageContext.request.contextPath}/login" method="post" id="loginForm">
                ...
                <div style="text-align:right;margin:-2px 0 10px">
                    <a href="${pageContext.request.contextPath}/forgot-password" style="font-size:.78rem;color:#60A5FA;text-decoration:none;font-weight:600;transition:color .3s" onmouseover="this.style.color='#93C5FD'" onmouseout="this.style.color='#60A5FA'"><i class="fas fa-key" style="font-size:.65rem;margin-right:4px"></i>Quên mật khẩu?</a>
                </div>
            ...
            <!-- Google Login Button -->
            <a href="${pageContext.request.contextPath}/google-auth" class="btn-google" id="googleLoginBtn">
            ...
            <style>
                .btn-google{display:flex;align-items:center;justify-content:center;gap:10px;width:100%;padding:13px 20px;background:#fff;border:1.5px solid #E2E8F0;border-radius:10px;font-size:.92rem;font-weight:600;color:#1E293B;cursor:pointer;transition:all .3s;font-family:'Inter',sans-serif;text-decoration:none;box-shadow:0 1px 3px rgba(0,0,0,.05)}
                .btn-google:hover{border-color:#4285F4;background:#F8FAFF;box-shadow:0 4px 14px rgba(66,133,244,.15);transform:translateY(-1px)}
                .btn-google:active{transform:translateY(0);box-shadow:0 1px 3px rgba(0,0,0,.08)}
