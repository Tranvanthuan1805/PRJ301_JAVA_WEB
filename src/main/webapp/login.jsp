            ...
            <style>
                * {
                ...
                .bg-pattern::before {
                    ...
                    width: 800px;
                    height: 800px;
                    background: radial-gradient(circle, rgba(37, 99, 235, .04), transparent 60%);
                    top: -200px;
                    right: -200px;
                    border-radius: 50%
                }
                ...
                .auth-container {
                    ...
                    overflow: hidden;
                    background: white;
                    box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.15), 0 0 0 1px rgba(0, 0, 0, .03);
                ...
                .auth-visual {
                    width: 45%;
                    padding: 50px;
                    background: linear-gradient(135deg, #1A2B49 0%, #2A3D5F 100%);
                    color: white;
                    display: flex;
                ...
                .auth-visual .logo-area {
                    margin-bottom: 40px;
                    position: relative;
                    z-index: 1
                }

                .auth-visual .logo-area h2 {
                    font-family: 'Playfair Display', serif;
                    font-size: 2rem;
                    font-weight: 800
                }

                .auth-visual .logo-area h2 span {
                    color: #3B82F6
                }
            ...
            <div class="auth-container">
                ...
                <div class="auth-form">
                    ...
                    <div class="social-btns" style="grid-template-columns:1fr">
                        <a href="https://cbbdijhwewpptvmgujcz.supabase.co/auth/v1/authorize?provider=google&redirect_to=${pageContext.request.scheme}://${pageContext.request.serverName}:${pageContext.request.serverPort}${pageContext.request.contextPath}/google-callback.jsp"
                            class="social-btn" style="width:100%;text-align:center;justify-content:center">
