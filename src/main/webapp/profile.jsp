...
<div class="container">
    ...
    <c:if test="${param.error == '2'}">
        <div class="alert alert-error"><i class="fas fa-exclamation-circle"></i> Email không được để trống!</div>
    </c:if>
    <c:if test="${param.error == '3'}">
        <div class="alert alert-error"><i class="fas fa-exclamation-circle"></i> Email này đã được sử dụng bởi tài khoản khác!</div>
    </c:if>
    ...
    <div class="card">
        ...
        <form action="${pageContext.request.contextPath}/profile" method="post">
            <div class="form-grid">
                ...
                <div class="form-group">
                    <label>Email</label>
                    <input type="email" name="email" value="${profileUser.email}" placeholder="Nhập email của bạn" required>
                </div>
                <div class="form-group">
                    <label>Họ và tên</label>
                    <input type="text" name="fullName" value="${profileUser.fullName}" placeholder="Nhập họ và tên" required>
                </div>
                <div class="form-group">
