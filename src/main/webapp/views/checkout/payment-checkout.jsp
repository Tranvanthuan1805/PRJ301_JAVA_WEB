            ...
            <head>
                ...
                <style>
                    ...
                    .qr-card {
                        ...
                        border-radius: 24px;
                        padding: 36px;
                        box-shadow: 0 8px 40px rgba(27, 31, 59, .08);
                    ...
                    .payment-check {
                        margin-top: 28px;
                        padding: 20px;
                        background: linear-gradient(135deg, rgba(255, 111, 97, .05), rgba(255, 154, 139, .03));
                        border: 1px solid rgba(255, 111, 97, .12);
                        border-radius: 16px
                    }
                    ...
                    .check-status.pending .icon {
                        background: #FFF8E1;
                        color: #D97706
                    }

                    .check-status.paid .icon {
                        background: #ECFDF5;
                        color: #059669
                    }
                    ...
                    .check-status .info .title {
                        font-weight: 700;
                        font-size: .85rem
                    }

                    .check-status .info .desc {
                        font-size: .75rem;
                        color: #A0A5C3;
                        margin-top: 2px
                    }
                    ...
                    .btn-my-orders:hover {
                        ...
                        box-shadow: 0 6px 20px rgba(27, 31, 59, .15)
                    }
            ...
            <body>
                            ...
                            <div class="trans-info">
                                ...
                                <div class="trans-row">
                                    ...
                                    <span class="value code">${transCode}
                                        <button class="copy-btn" onclick="copyCode()" title="Sao chép"><i
                                ...
                                <div class="payment-check">
                                    ...
                                    <div class="check-status pending" id="checkStatus">
                                        ...
                                        <div class="info">
                                            ...
                                            <div class="desc" id="statusDesc">Quét mã QR và chuyển khoản đúng số tiền
                                            </div>
                                        </div>
                                    </div>
                ...
                <script>
                    ...
                    function checkPayment() {
                        ...
                        setTimeout(() => {
                            // Start polling our backend endpoint
                            fetch('${pageContext.request.contextPath}/check-payment?code=' + '${transCode}')
                                ...
                                .then(data => {
                                    if (data && data.status === 'Paid') {
                                        ...
                                        btn.disabled = false;
                                        document.getElementById('statusDesc').textContent = 'Chưa phát hiện giao dịch hoặc đang xử lý. Thử kiểm tra lại sau 30s.';
                                    }
                                })
                                .catch(() => {
                                    btn.innerHTML = '<i class="fas fa-sync-alt"></i> Kiểm Tra Lại';
