...
/* ═══ CART ICON ═══ */
.cart-icon-link{position:relative;color:#475569;font-size:1.2rem;transition:.3s;display:flex;align-items:center;text-decoration:none}
.cart-icon-link:hover{color:#2563EB}
.cart-badge{position:absolute;top:-8px;right:-8px;background:#EF4444;color:#fff;border-radius:50%;width:18px;height:18px;display:flex;align-items:center;justify-content:center;font-size:.65rem;font-weight:700;box-shadow:0 2px 8px rgba(239,68,68,.4)}
...
<nav class="hdr-nav">
    <div class="hdr-nav-inner">
        ...
        <ul class="nav-links">
            ...
            <li><a href="${pageContext.request.contextPath}/explore" data-i18n="nav.explore">Khám Phá</a></li>
