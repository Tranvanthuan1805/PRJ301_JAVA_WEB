        ...
        <div class="top-bar">
            <div class="top-bar-inner">
                <div class="top-bar-left">
                    <a href="tel:0335111783"><i class="fas fa-phone-alt"></i> <span data-i18n="topbar.phone">0335 111
                            783</span></a>
        ...
        <nav class="hdr-nav">
            <div class="hdr-nav-inner">
                <a href="${pageContext.request.contextPath}/" class="logo">
                    <img src="${pageContext.request.contextPath}/images/logo.png" alt="eztravel"
                ...
                <ul class="nav-links">
                    ...
                    <li class="nav-dropdown">
                        ...
                        <div class="nav-dropdown-menu">
                            ...
                            <a href="${pageContext.request.contextPath}/admin/providers?type=Hotel">
                                <i class="fas fa-hotel"></i> Khách sạn
                            </a>
                            <a href="${pageContext.request.contextPath}/admin/providers?type=TourOperator">
                                <i class="fas fa-map-marked-alt"></i> Công ty Tour
                            </a>
                            <a href="${pageContext.request.contextPath}/admin/providers?type=Transport">
                                <i class="fas fa-bus"></i> Vận chuyển
                            </a>
                        </div>
                    </li>
                </ul>
