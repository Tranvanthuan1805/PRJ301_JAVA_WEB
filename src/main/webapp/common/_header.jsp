<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <style>
            ...
            .top-bar-brand-name .ez-highlight {
                color: #2563EB
            }
            ...
            .top-bar-info-item:hover .top-bar-info-icon {
                border-color: #2563EB;
            ...
            .top-bar-info-value a {
                color: #64748B;
                text-decoration: none;
                transition: .3s
            }

            .top-bar-info-value a:hover {
                color: #2563EB
            }
            ...
            .top-bar-social a:hover.yt {
                color: #fff;
                background: #FF0000;
                border-color: #FF0000
            }

            .top-bar-social a:hover.fb {
                color: #fff;
                background: #1877F2;
                border-color: #1877F2
            }

            .top-bar-social a:hover.ig {
                color: #fff;
                background: linear-gradient(45deg, #f09433, #e6683c, #dc2743, #cc2366, #bc1888);
                border-color: #dc2743
            }

            .top-bar-social a:hover.tt {
                color: #fff;
                background: #000;
                border-color: #000
            }
                ...
                <a href="${pageContext.request.contextPath}/" class="top-bar-brand">
                    <div class="top-bar-logo-icon">
                        <svg viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <rect x="2" y="2" width="52" height="52" rx="12" fill="#fff" stroke="#2563EB"
                                stroke-width="2.5" />
                            <path d="M28 12l-14 20h8v12h12V32h8L28 12z" fill="#2563EB" opacity=".15" />
                            <path d="M20 28l8-12 8 12" stroke="#2563EB" stroke-width="2.5" stroke-linecap="round"
                    ...
                    <div class="top-bar-info-track" id="infoTrack">
                        ...
                        <div class="top-bar-info-item">
                            ...
                            <div class="top-bar-info-content">
                                ...
                                <span class="top-bar-info-value"><a
                                        href="mailto:eztravel@gmail.com">eztravel@gmail.com</a></span>
                            </div>
                        </div>
                        <div class="top-bar-info-item">
        ...
        <nav class="hdr-nav">
            <div class="hdr-nav-inner">
                ...
                <ul class="nav-links">
                    <li><a href="${pageContext.request.contextPath}/" data-i18n="nav.home"><i class="fas fa-home"></i>
                            Trang Chủ</a></li>
                    <li><a href="${pageContext.request.contextPath}/tour" data-i18n="nav.explore"><i
                                class="fas fa-compass"></i> Khám Phá</a></li>
                    <li><a href="${pageContext.request.contextPath}/my-orders" data-i18n="nav.orders"><i
                                class="fas fa-receipt"></i> Đơn Hàng</a></li>
                    <li><a href="${pageContext.request.contextPath}/history" data-i18n="nav.history"><i
                                class="fas fa-history"></i> Lịch Sử</a></li>
                    <li><a href="${pageContext.request.contextPath}/provider" data-i18n="nav.provider"><i
                                class="fas fa-handshake"></i> Nhà Cung Cấp</a></li>
                </ul>

                <div style="display:flex;align-items:center;gap:14px">
                    <!-- Search box -->
                    <form class="nav-search" action="${pageContext.request.contextPath}/tour" method="GET">
                        <input type="text" name="search" placeholder="Tìm kiếm tour..." data-i18n="search.placeholder"
                            autocomplete="off">
                    ...
                    <div class="hdr-actions">
                        <c:choose>
                                ...
                                <div class="notif-wrapper" id="notifWrapper">
                                    ...
                                    <div class="notif-dropdown" id="notifDropdown">
                                        <div class="notif-header">
                                            <span>Thông báo</span>
                                            <button class="notif-mark-all" onclick="NotifUI.markAll()">Đánh dấu đã
                                                đọc</button>
                                        </div>
                                        <div class="notif-list" id="notifList">
                                            <div class="notif-empty" id="notifEmpty">Chưa có thông báo nào</div>
                                        </div>
                                        <div class="notif-footer">
                                            <a href="${pageContext.request.contextPath}/admin/provider-requests">Xem tất
                                                cả yêu cầu NCC</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <c:otherwise>
                                <a href="${pageContext.request.contextPath}/login.jsp" class="btn-hdr-login"
                                    data-i18n="nav.login">Đăng Nhập</a>
