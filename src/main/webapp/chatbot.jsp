        ...
        chatForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                if (response.status === 403) {
                    addMessage('<strong>Upgrade Required:</strong> ' + data.message + ' <br><br><a href="${pageContext.request.contextPath}/pricing.jsp" style="color: var(--primary); font-weight: 700;">View Pricing</a>', 'bot');
                } else {
