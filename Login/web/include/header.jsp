...
<header class="header">
    <div class="container">
        ...
        <nav class="nav-menu">
            ...
            <a href="${pageContext.request.contextPath}/customer?action=dashboard" class="nav-item ${nav == 'customer' ? 'active' : ''}">Khách hàng</a>
            <a href="${pageContext.request.contextPath}/booking?action=list" class="nav-item ${nav == 'booking' ? 'active' : ''}">Booking</a>
        </nav>
    </div>
</header>
