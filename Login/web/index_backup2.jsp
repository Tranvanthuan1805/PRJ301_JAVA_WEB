...
<body>
    ...
    <section class="hero">
        ...
        <div class="hero-content">
            ...
            <!-- Service Tabs - Chỉ giữ Tour du lịch -->
            ...
            <div class="search-container">
                ...
                <!-- Search Form -->
                <form class="search-form" id="searchForm" action="user-tours" method="get">
                    <div class="search-grid">
                        <div class="search-field destination-field">
                            ...
                            <div class="input-wrapper">
                                <input type="text" id="destination" placeholder="Bạn muốn đi đâu?" list="destinations">
                        ...
                        <div class="search-field">
                            ...
                            <div class="input-wrapper">
                                <input type="date" id="departDate" value="2026-02-04">
                            </div>
                        </div>
                        ...
                        <button type="submit" class="search-btn" style="background: #ff6b35 !important; color: white !important; padding: 16px 24px !important; border: none !important; border-radius: 8px !important; font-size: 16px !important; font-weight: 700 !important; cursor: pointer !important; display: flex !important; align-items: center !important; justify-content: center !important; gap: 10px !important;">
                            <i class="fas fa-search" style="color: white !important; font-size: 18px !important;"></i>
                            <span style="color: white !important; font-size: 16px !important; font-weight: 700 !important;">Tìm kiếm ngay</span>
                        </button>
                    </div>
                </form>
                ...
                <div class="featured-tours-section" id="featuredToursSection" style="display: none;">
                    ...
                    <div class="featured-footer">
                        <a href="user-tours" class="btn-view-featured">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-item professional-stat">
                    ...
                    <div class="stat-content">
                        ...
                        <span class="stat-description">Tin tưởng & yêu thích VietAir</span>
                    </div>
                    <div class="stat-decoration">
                        <div class="decoration-dot"></div>
                        <div class="decoration-line"></div>
                ...
                <div class="stat-item professional-stat">
                    ...
                    <div class="stat-content">
                        ...
                        <span class="stat-description">Chất lượng dịch vụ xuất sắc</span>
                    </div>
                    <div class="stat-decoration">
                        <div class="decoration-dot"></div>
                        <div class="decoration-line"></div>
                    ...
                    <div class="card-overlay">
                        ...
                        <div class="card-content">
                            ...
                            <div class="card-stats">
                                ...
                                <span class="stat-text">Từ khu vực Đà Nẵng</span>
                            </div>
                            <div class="card-features">
                                <span class="feature-item">👑 Khách VIP</span>
                                <span class="feature-item">💎 Ưu đãi đặc biệt</span>
                            </div>
                        </div>
                    </div>
                </a>
                ...
                <a href="booking?action=list" class="action-card booking-card">
                    ...
                    <div class="card-overlay">
                        ...
                        <div class="card-content">
                            ...
                            <p>Theo dõi và quản lý tất cả vé đặt tour với mã booking độc quyền</p>
                            <div class="card-stats">
                                <span class="stat-badge">50+ booking</span>
                                <span class="stat-text">Đã được xác nhận thành công</span>
                            </div>
                            <div class="card-features">
                                <span class="feature-item">🎫 Mã vé VT</span>
                                <span class="feature-item">✅ Xác nhận nhanh</span>
                            </div>
                        </div>
                    </div>
                </a>
                ...
                <a href="customer?action=ranking" class="action-card featured-card">
                    ...
                    <div class="card-overlay">
                        ...
                        <div class="card-content">
                            ...
                            <p>Xếp hạng và vinh danh những khách hàng thân thiết nhất của VietAir</p>
                            <div class="card-stats">
                                <span class="stat-badge">Top Ranking</span>
                                <span class="stat-text">Khách hàng VIP đặc biệt</span>
                            </div>
                            <div class="card-features">
                                <span class="feature-item">🏆 Bảng xếp hạng</span>
                                <span class="feature-item">⭐ Điểm thưởng</span>
                            </div>
                        </div>
                    </div>
                </a>
    ...
    <section class="destinations">
        <div class="container">
            ...
            <div class="destination-grid professional-tours" id="popularTours">
                <!-- Loading placeholders -->
                <div class="destination-card professional-tour-card loading-card">
            ...
            <div class="footer-content">
                ...
                <div class="footer-section">
                    ...
                    <ul>
                        ...
                        <li><a href="tour?action=available">Tour nổi bật</a></li>
    ...
    <script>
        // Tab switching functionality - Updated for functional tabs
        ...
        document.getElementById('featuredTab').addEventListener('click', () => {
            ...
            // Load featured tours when tab is clicked
            loadFeaturedTours();
        });

        // Load featured tours function
        async function loadFeaturedTours() {
            try {
                const response = await fetch('api/tours?action=popular');
                const data = await response.json();
                
                if (data.tours && data.tours.length > 0) {
                    const featuredGrid = document.getElementById('featuredToursGrid');
                    // Chỉ lấy tour Đà Nẵng
                    const danangTours = data.tours.filter(tour => 
                        tour.destination && (
                            tour.destination.includes('Đà Nẵng') ||
                            tour.destination.includes('Hải Châu') ||
                            tour.destination.includes('Thanh Khê') ||
                            tour.destination.includes('Sơn Trà') ||
                            tour.destination.includes('Ngũ Hành Sơn') ||
                            tour.destination.includes('Liên Chiểu') ||
                            tour.destination.includes('Cẩm Lệ') ||
                            tour.destination.includes('Hòa Vang') ||
                            tour.destination.includes('Hoàng Sa')
                        )
                    );
                    
                    featuredGrid.innerHTML = danangTours.slice(0, 6).map(tour => `
                        <div class="featured-tour-item" onclick="window.location.href='tour-detail?id=${tour.id}'" style="cursor: pointer;">
                            <div class="featured-tour-image">
                                <img src="https://images.unsplash.com/photo-${getImageId(tour.destination)}?w=300&h=200&fit=crop&auto=format" alt="${tour.destination}">
                                <div class="featured-badge ${getBadgeClass(tour)}">${getBadgeText(tour)}</div>
                            </div>
                            <div class="featured-tour-content">
                                ...
                                <div class="featured-price">
                                    <span class="price">${tour.price.toLocaleString()} VNĐ</span>
                                ...
                                <div class="featured-rating">
                                    ...
                                    <span class="rating-text">4.9 (${Math.floor(Math.random() * 100) + 50} đánh giá)</span>
                                </div>
                                <a href="tour-detail?id=${tour.id}" class="btn-book-now" onclick="event.stopPropagation();">
        ...
        function loadDefaultFeaturedTours() {
            const featuredGrid = document.getElementById('featuredToursGrid');
            featuredGrid.innerHTML = `
                <div class="featured-tour-item" onclick="window.location.href='tour-detail?id=1'" style="cursor: pointer;">
                    <div class="featured-tour-image">
                        <img src="https://images.unsplash.com/photo-1583417319070-4a69db38a482?w=300&h=200&fit=crop&auto=format" alt="Cầu Vàng Bà Nà Hills">
                        <div class="featured-badge hot">Hot</div>
                    </div>
                    <div class="featured-tour-content">
                        <h4>Tour Quận Hải Châu 3N2Đ</h4>
                        <p class="featured-location">
                            <i class="fas fa-map-marker-alt"></i>
                            Hải Châu, Đà Nẵng
                        </p>
                        ...
                        <a href="tour-detail?id=1" class="btn-book-now" onclick="event.stopPropagation();">
                            <i class="fas fa-info-circle"></i> Xem chi tiết
                        </a>
                    </div>
                </div>
                
                <div class="featured-tour-item" onclick="window.location.href='tour-detail?id=2'" style="cursor: pointer;">
                    <div class="featured-tour-image">
                        <img src="https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=300&h=200&fit=crop&auto=format" alt="Bãi biển Mỹ Khê">
                        <div class="featured-badge trending">Trending</div>
                    </div>
                    <div class="featured-tour-content">
                        <h4>Tour Bán đảo Sơn Trà 4N3Đ</h4>
                        <p class="featured-location">
                            <i class="fas fa-map-marker-alt"></i>
                            Sơn Trà, Đà Nẵng
                        </p>
                        ...
                        <a href="tour-detail?id=2" class="btn-book-now" onclick="event.stopPropagation();">
                            <i class="fas fa-info-circle"></i> Xem chi tiết
                        </a>
                    </div>
                </div>
                
                <div class="featured-tour-item" onclick="window.location.href='tour-detail?id=3'" style="cursor: pointer;">
                    <div class="featured-tour-image">
                        <img src="https://images.unsplash.com/photo-1528127269322-539801943592?w=300&h=200&fit=crop&auto=format" alt="Bán đảo Sơn Trà">
                        <div class="featured-badge premium">Premium</div>
                    </div>
                    <div class="featured-tour-content">
                        <h4>Tour Ngũ Hành Sơn 3N2Đ</h4>
                        <p class="featured-location">
                            <i class="fas fa-map-marker-alt"></i>
                        ...
                        <a href="tour-detail?id=3" class="btn-book-now" onclick="event.stopPropagation();">
                            <i class="fas fa-info-circle"></i> Xem chi tiết
                        </a>
                    </div>
                </div>
                
                <div class="featured-tour-item" onclick="window.location.href='tour-detail?id=4'" style="cursor: pointer;">
                    <div class="featured-tour-image">
                        <img src="https://images.unsplash.com/photo-1555881400-74d7acaacd8b?w=300&h=200&fit=crop&auto=format" alt="Cầu Rồng Đà Nẵng">
                        <div class="featured-badge hot">Hot</div>
                    </div>
                    <div class="featured-tour-content">
                        <h4>Tour Thanh Khê 2N1Đ</h4>
                        <p class="featured-location">
                            <i class="fas fa-map-marker-alt"></i>
                            Thanh Khê, Đà Nẵng
                        </p>
                        ...
                        <a href="tour-detail?id=4" class="btn-book-now" onclick="event.stopPropagation();">
                            <i class="fas fa-info-circle"></i> Xem chi tiết
                        </a>
                    </div>
                </div>
                
                <div class="featured-tour-item" onclick="window.location.href='tour-detail?id=5'" style="cursor: pointer;">
                    <div class="featured-tour-image">
                        <img src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=300&h=200&fit=crop&auto=format" alt="Núi Thần Tài">
                        <div class="featured-badge trending">Trending</div>
                    </div>
                    <div class="featured-tour-content">
                        <h4>Tour Liên Chiểu 3N2Đ</h4>
                        <p class="featured-location">
                            <i class="fas fa-map-marker-alt"></i>
                            Liên Chiểu, Đà Nẵng
                        </p>
                        ...
                        <a href="tour-detail?id=5" class="btn-book-now" onclick="event.stopPropagation();">
                            <i class="fas fa-info-circle"></i> Xem chi tiết
                        </a>
                    </div>
                </div>
                
                <div class="featured-tour-item" onclick="window.location.href='tour-detail?id=6'" style="cursor: pointer;">
                    <div class="featured-tour-image">
                        <img src="https://images.unsplash.com/photo-1551244072-5d12893278ab?w=300&h=200&fit=crop&auto=format" alt="Làng Cổ Hội An">
                        <div class="featured-badge premium">Premium</div>
                    </div>
                    <div class="featured-tour-content">
                        <h4>Tour Cẩm Lệ 2N1Đ</h4>
                        <p class="featured-location">
                            <i class="fas fa-map-marker-alt"></i>
                            Cẩm Lệ, Đà Nẵng
                        </p>
                        ...
                        <a href="tour-detail?id=6" class="btn-book-now" onclick="event.stopPropagation();">
                            <i class="fas fa-info-circle"></i> Xem chi tiết
                        </a>
                    </div>
                </div>
        ...
        const modernCardStyles = `
            ...
            .modern-card:hover .card-bg-image {
            ...
            .modern-card:nth-child(1) { animation: float 6s ease-in-out infinite; }
            .modern-card:nth-child(2) { animation: float 6s ease-in-out infinite 1.5s; }
            .modern-card:nth-child(3) { animation: float 6s ease-in-out infinite 3s; }
            .modern-card:nth-child(4) { animation: float 6s ease-in-out infinite 4.5s; }
        `;
        
        // Add professional stats styles
        const professionalStatsStyles = `
            .professional-stat {
            ...
            .professional-stat:nth-child(1) .professional-icon {
                background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
                box-shadow: 0 8px 25px rgba(102, 126, 234, 0.3);
            }
            
            .professional-stat:nth-child(2) .professional-icon {
                background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%);
                box-shadow: 0 8px 25px rgba(240, 147, 251, 0.3);
            }
            
            .professional-stat:nth-child(3) .professional-icon {
                background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%);
                box-shadow: 0 8px 25px rgba(79, 172, 254, 0.3);
            }
            
            .professional-stat:nth-child(4) .professional-icon {
                background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%);
            ...
            .professional-stat:nth-child(1) { animation-delay: 0.1s; }
            .professional-stat:nth-child(2) { animation-delay: 0.2s; }
            .professional-stat:nth-child(3) { animation-delay: 0.3s; }
            .professional-stat:nth-child(4) { animation-delay: 0.4s; }
        `;
        
        // Add professional stats styles to head
        const professionalStatsStyleSheet = document.createElement('style');
        professionalStatsStyleSheet.textContent = professionalStatsStyles;
        document.head.appendChild(professionalStatsStyleSheet);
        ...
        // Add professional tour cards styles
        const professionalTourStyles = `
            .professional-header {
                text-align: center;
                margin-bottom: 4rem;
                position: relative;
            ...
            .professional-tour-card:hover .tour-bg-image {
                transform: scale(1.1);
            }
            ...
            .professional-tour-card:hover .tour-action {
                transform: scale(1.1);
        ...
        // Add professional tour styles to head
        const professionalTourStyleSheet = document.createElement('style');
        professionalTourStyleSheet.textContent = professionalTourStyles;
        document.head.appendChild(professionalTourStyleSheet);
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Load tours after DOM is ready
            loadPopularTours();
        });

        // Destination suggestions with API call
        ...
        destinationInput.addEventListener('input', async (e) => {
            ...
            try {
                const response = await fetch(`api/tours?action=destinations&q=${encodeURIComponent(value)}`);
                const data = await response.json();
                
                if (data.suggestions && data.suggestions.length > 0) {
                    suggestionsDiv.innerHTML = data.suggestions.map(item => 
                        `<div class="suggestion-item" onclick="selectDestination('${item.destination}')">
                            <i class="fas fa-map-marker-alt"></i>
                            <div>
                                <div class="suggestion-name">${item.destination}</div>
                                <div class="suggestion-full">${item.description} - ${item.tourCount} tours từ ${item.minPrice.toLocaleString()} VNĐ</div>
                            </div>
                        </div>`
                    ).join('');
        ...
        async function loadPopularTours() {
            try {
                ...
                if (data.tours && data.tours.length > 0) {
                    const popularToursContainer = document.getElementById('popularTours');
                    popularToursContainer.innerHTML = data.tours.map(tour => `
                        <div class="destination-card" onclick="window.location.href='tour?action=view&id=${tour.id}'" style="cursor: pointer;">
                            <div class="destination-image">
                                <img src="https://images.unsplash.com/photo-${getImageId(tour.destination)}?w=400&h=300&fit=crop" alt="${tour.destination}">
                                <div class="destination-overlay">
                                    <div class="destination-badge ${getBadgeClass(tour)}">${getBadgeText(tour)}</div>
                                </div>
                            </div>
                            <div class="destination-info">
                                <h3>${tour.name}</h3>
                                <p>${tour.destination} - ${tour.duration || '3N2Đ'}</p>
                                <div class="destination-details">
                                    <span class="tour-count">${tour.availableSlots || (tour.maxCapacity - tour.currentCapacity)} chỗ còn</span>
                                    <span class="price-from">${tour.price.toLocaleString()} VNĐ</span>
                                </div>
                            </div>
                        </div>
                    `).join('');
                } else {
                    // Fallback với tours mặc định nếu API không có dữ liệu
                    loadDefaultTours();
                }
            } catch (error) {
                console.error('Error loading popular tours:', error);
                // Fallback với tours mặc định nếu API lỗi
                loadDefaultTours();
            }
        }

        function loadDefaultTours() {
            const popularToursContainer = document.getElementById('popularTours');
            popularToursContainer.innerHTML = `
                <div class="destination-card professional-tour-card" onclick="window.location.href='tour?action=view&id=1'" style="cursor: pointer;">
                    ...
                    <div class="tour-badge premium-tour">Phổ biến</div>
                    <div class="tour-content">
                ...
                <div class="destination-card professional-tour-card" onclick="window.location.href='tour?action=view&id=2'" style="cursor: pointer;">
                    ...
                    <div class="tour-badge trending-tour">Trending</div>
                    <div class="tour-content">
                        <div class="tour-location">
                            <i class="fas fa-map-marker-alt"></i>
                ...
                <div class="destination-card professional-tour-card" onclick="window.location.href='tour?action=view&id=3'" style="cursor: pointer;">
                    ...
                    <div class="tour-badge hot-tour">Hot</div>
                    <div class="tour-content">
                        <div class="tour-location">
                            <i class="fas fa-map-marker-alt"></i>
                ...
                <div class="destination-card professional-tour-card" onclick="window.location.href='tour?action=view&id=4'" style="cursor: pointer;">
                    ...
                    <div class="tour-badge premium-tour">Premium</div>
                    <div class="tour-content">
                        <div class="tour-location">
                            <i class="fas fa-map-marker-alt"></i>
        ...
        function getImageId(destination) {
            const imageMap = {
                // Các quận trong thành phố Đà Nẵng
                'Hải Châu': '1583417319070-4a69db38a482', // Cầu Rồng và trung tâm Đà Nẵng
                'Thanh Khê': '1559592413-7cec4d0cae2b', // Khu đô thị hiện đại
                'Sơn Trà': '1528127269322-539801943592', // Bán đảo Sơn Trà với chùa Linh Ứng
                'Ngũ Hành Sơn': '1574263867128-ce3b8c1b6b8f', // Ngũ Hành Sơn với hang động
                'Liên Chiểu': '1578662996442-374dcbcbc495', // Khu vực sân bay và phát triển mới
                'Cẩm Lệ': '1506905925346-21bda4d32df4', // Khu vực nông thôn kết hợp đô thị
                'Hòa Vang': '1583417319070-4a69db38a482', // Bà Nà Hills với cầu Vàng
                'Hoàng Sa': '1559592413-7cec4d0cae2b' // Quần đảo Hoàng Sa
            };
            return imageMap[destination] || '1583417319070-4a69db38a482';
        }

        function getBadgeClass(tour) {
            const available = tour.maxCapacity - tour.currentCapacity;
            if (available <= 0) return 'premium';
            if (available <= 5) return 'trending';
            return '';
        }

        function getBadgeText(tour) {
            const available = tour.maxCapacity - tour.currentCapacity;
        ...
        // Load popular tours on page load
        document.addEventListener('DOMContentLoaded', function() {
            loadPopularTours();
        });
        ...
        document.getElementById('searchForm').addEventListener('submit', (e) => {
            ...
            if (departDate) params.push(`date=${departDate}`);
            if (passengers) params.push(`passengers=${passengers}`);
